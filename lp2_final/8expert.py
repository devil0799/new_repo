...
class Evaluation:
    def __init__(self) -> None:
        ...
        self.competencies = {"Communication" : [0,0,0],"Productivity" : [0,0,0],"Creativity" : [0,0,0],"Integrity" : [0,0,0],"Punctuality" : [0,0,0]}
        self.performance = {"Goal 1" : [0,0,0],"Goal 2" : [0,0,0],"Goal 3" : [0,0,0],"Goal 4" : [0,0,0],"Goal 5" : [0,0,0]}       
